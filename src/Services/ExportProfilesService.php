...
use Solspace\FreeformPro\Events\ExportProfiles\DeleteEvent;
use Solspace\FreeformPro\Events\ExportProfiles\SaveEvent;
use Solspace\FreeformPro\Models\ExportProfileModel;
use Solspace\FreeformPro\Records\ExportProfileRecord;
...
class ExportProfilesService extends Component
{
    ...
    private function createExportProfile(array $data): ExportProfileModel
    {
        ...
        if (\is_string($exportProfile->statuses) && $exportProfile->statuses !== '') {
